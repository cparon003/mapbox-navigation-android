...
class ReRouteActivity : AppCompatActivity(), OnMapReadyCallback, PermissionsListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapboxNavigation = MapboxNavigation(
            ...
            it.registerOffRouteObserver(offRouteObserver)
        }
            ...
            if (offRoute) {
                mapView.getMapAsync { mapboxMap ->
                    if (mapboxMap.locationComponent.lastKnownLocation != null) {
                        val newOriginPoint = Point.fromLngLat(
                        ...
                        val newCoordinates = listOf(newOriginPoint, destinationPoint)
                        val updatedRouteOptions = mapboxNavigation!!.getRoutes()[0]
                                .routeOptions()!!
                                .toBuilder()
